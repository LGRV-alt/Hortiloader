...
export default function Header({
  ...
  return (
    <header className="border-b-2 border-slate-200 bg-regal-blue text-white px-4 py-2 flex justify-between items-center relative shadow">
            ...
            {edit ? (
              ...
              <div className="flex gap-2">
                ...
                <Link to="/createCustomer">
                  <button className="bg-green-600 px-3 py-1 rounded hover:bg-green-700 hidden md:flex">
                    Add Order
                  </button>
                </Link>
      ...
      {menuOpen && (
        <div className="text-center absolute top-full right-0 mt-2 bg-black bg-opacity-95 text-white shadow-md z-50 flex flex-col gap-4 px-6 py-4 rounded-md w-48">
          <NavLink
            to="/"
