...
export default function ViewTask() {
  ...
  return (
    <div className=" p-2 md:p-6 dark:bg-darkMain bg-[#ffffff] h-full grid md:grid-cols-[2fr_1fr] gap-4 text-sm md:text-lg  ">
      ...
      {/* ------------Task---------------- */}
      <div className=" grid grid-rows-[2fr_3fr_1fr] border-[3px] overflow-hidden border-darkBorder h-full  rounded-2xl text-xs md:text-lg shadow-lg dark:shadow-darkSecondary shadow-gray-400  dark:bg-darkSecondary bg-white ">
        {/* ------ HEADER ------ */}
        <div className="grid grid-cols-[2fr_1fr] p-4  dark:bg-darkMain bg-regal-blue border-b-[3px] border-darkBorder text-white ">
